...
//    private String data;
//    private ArrayList<Person> samples;
...
//            Person s = samples.get(i);
//            Person prev = samples.get(i-1);
...
//        ArrayList<Person> result = h.getLoudSamples(70, samples);
//        
//        int expected = 5;
...
//        ArrayList<Person> result = h.getSamplesBefore(new Time("12:05"), samples);
//        
//        int expected = 4;
//        int actual = result.size();
//        assertEquals(expected, actual);
...
//        samples.add(new PersonImpl("24-12-2017", new Time("12:01"), 63));
//        samples.add(new PersonImpl("24-12-2017", new Time("12:02"), 79));
//        samples.add(new PersonImpl("24-12-2017", new Time("12:03"), 41));
//        samples.add(new PersonImpl("24-12-2017", new Time("12:04"), 70));
//        samples.add(new PersonImpl("24-12-2017", new Time("12:05"), 64));
//        samples.add(new PersonImpl("24-12-2017", new Time("12:06"), 66));
//        samples.add(new PersonImpl("24-12-2017", new Time("12:07"), 72));
//        samples.add(new PersonImpl("24-12-2017", new Time("12:08"), 47));
//        samples.add(new PersonImpl("24-12-2017", new Time("12:09"), 20));
//        samples.add(new PersonImpl("24-12-2017", new Time("12:10"), 52));
//        samples.add(new PersonImpl("24-12-2017", new Time("12:11"), 41));
//        samples.add(new PersonImpl("24-12-2017", new Time("12:12"), 64));
//        samples.add(new PersonImpl("24-12-2017", new Time("12:13"), 44));
//        samples.add(new PersonImpl("24-12-2017", new Time("12:14"), 65));
//        samples.add(new PersonImpl("24-12-2017", new Time("12:15"), 45));
//        samples.add(new PersonImpl("24-12-2017", new Time("12:16"), 47));
//        samples.add(new PersonImpl("24-12-2017", new Time("12:17"), 72));
//        samples.add(new PersonImpl("24-12-2017", new Time("12:18"), 59));
//        samples.add(new PersonImpl("24-12-2017", new Time("12:19"), 47));
//        samples.add(new PersonImpl("24-12-2017", new Time("12:20"), 56));
//        samples.add(new PersonImpl("24-12-2017", new Time("12:21"), 71));
//        samples.add(new PersonImpl("24-12-2017", new Time("12:21"), 65));
//        samples.add(new PersonImpl("24-12-2017", new Time("12:21"), 54));
//        samples.add(new PersonImpl("24-12-2017", new Time("12:21"), 65));
//    }
//
//    @AfterClass
